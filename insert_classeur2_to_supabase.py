...
EXCEL_PATH = r"C:\Users\houno\Downloads\Classeur2.xlsx"
...
def insert():
    ...
    service = DatabaseService(DatabaseConfig.from_mapping(secrets["database"]))
    ...
    print(f"Insertion Classeur2 terminée : {inserted} ligne(s) insérée(s), {skipped} ligne(s) ignorée(s).")
